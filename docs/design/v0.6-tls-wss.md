...
- [x] `v run examples/https_hello` works with `scripts/dev-cert.sh` output
- [x] `v run examples/wss_echo` (or dedicated wss example) over TLS
- [x] TLS + WSS tests green in CI
- [x] `docs/tls.md` published; README: optional TLS, proxy still fine
- [x] ROADMAP v0.6a/v0.6b checkboxes updated
